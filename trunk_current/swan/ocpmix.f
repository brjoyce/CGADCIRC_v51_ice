...
!           Assign free unit number
            ...
            ELSE
               IFUN = IFUN + 1
            ENDIF
!           the following unit numbers are reserved for ADCIRC            41.20
            IF ( IFUN.EQ.13 ) GOTO 60                                     41.20
            IF ( IFUN.EQ.14 ) GOTO 60                                     41.20
            IF ( IFUN.EQ.15 ) GOTO 60                                     41.20
            IF ( IFUN.EQ.22 ) GOTO 60                                     41.20
            IUNIT = IFUN
