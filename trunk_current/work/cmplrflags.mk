...
ifeq ($(compiler),gnu-ND)
  PPFC          :=  gfortran
  FC            :=  gfortran
  PFC           :=  mpif90
  ifeq ($(AMD),yes)
#     FFLAGS1     :=  $(INCDIRS) -g -O3 -ffixed-line-length-132 -mcmodel=medium 

     FFLAGS1     :=  $(INCDIRS) -g -O3 -ffixed-line-length-132 -mcmodel=medium -mtune=native -v

  else
     FFLAGS1     :=  $(INCDIRS) -g -backtrace -O3 -msse4.2 -ffixed-line-length-132 -mcmodel=medium 
  endif
  ifeq ($(DEBUG),full)
     FFLAGS1       :=  $(INCDIRS) -g -O0 -backtrace -mdebug -Wall -ffixed-line-length-132 -DALL_TRACE -DFULL_STACK -DFLUSH_MESSAGES
  endif
  FFLAGS2       :=  $(FFLAGS1)
  FFLAGS3       :=  $(FFLAGS1)
  DA            :=  -DREAL8 -DLINUX -DCSCA
#  DP            :=  -DREAL8 -DLINUX -DCSCA -DCMPI -DPOWELL -DADCSWAN
  DP            :=  -DREAL8 -DLINUX -DCSCA -DCMPI -DADCSWAN 
  ...
  CCBE          := $(CC)
  ifeq ($(AMD),yes)
     CFLAGS        := $(INCDIRS) -O3 -mcmodel=medium -DLINUX
  else
     CFLAGS        := $(INCDIRS) -O3 -msse4.2 -mcmodel=medium -DLINUX
  endif
  FLIBS          :=
  ifeq ($(DEBUG),full)
     CFLAGS        := $(INCDIRS) -g -O0 -mcmodel=medium -backtrace -DLINUX
  endif
  ifeq ($(NETCDF),enable)
     HDF5HOME=/afs/crc.nd.edu/x86_64_linux/hdf/hdf5-1.8.6-linux-x86_64-static/lib
 
     NETCDFHOME=/afs/crc.nd.edu/x86_64_linux/netcdf/rhel6/4.1.3/gcc-4.4.7
...
ifeq ($(compiler),intel-ND)
  ...
  PFC           :=  mpif90
  ifeq ($(ZAS),yes)
# O3 appears to be an offensive on AMD chips 
#     FFLAGS1     :=  $(INCDIRS) -g -traceback -w -O3 -assume byterecl -132 -i-dynamic -assume buffered_io

# This is for debug
#     FFLAGS1     :=  $(INCDIRS) -g -traceback -w -O0 -check bounds -assume byterecl -132 -i-dynamic -assume buffered_io

# Make sure that O3 is the offensive option	
#     FFLAGS1     :=  $(INCDIRS) -g -traceback -w -O3 -assume byterecl -132 -i-dynamic
#     FFLAGS1     :=  $(INCDIRS) -g -traceback -O2 -assume byterecl -132 -mcmodel=medium -shared-intel
     FFLAGS1     :=  $(INCDIRS) -g -traceback -O3 -assume byterecl -132 -mcmodel=medium -shared-intel

#  -xHost leads to disastor on DACSS, bulldozer
#     FFLAGS1     :=  $(INCDIRS) -g -traceback -O3 -xHost -assume byterecl -132 -mcmodel=medium -shared-intel
# -assume buffered_io

#   DW-for debuging
#     FFLAGS1     :=  $(INCDIRS) -g -traceback -w -O0 -assume byterecl -132 -i-dynamic -assume buffered_io
  else
      FFLAGS1     :=  $(INCDIRS) -O3 -xSSE4.2 -assume byterecl -132 -mcmodel=medium -shared-intel -assume buffered_io
  endif
  ifeq ($(DEBUG),full)
     FFLAGS1       :=  $(INCDIRS) -g -O0 -traceback -debug -check all -i-dynamic -FI -assume byterecl -132 -DALL_TRACE -DFULL_STACK -DFLUSH_MESSAGES
  endif
...
#  DP            :=  -DREAL8 -DLINUX -DCSCA -DCMPI -DPOWELL -DADCSWAN
  ...
  CCBE          := $(CC)
  ifeq ($(ZAS),yes)
#     CFLAGS        := $(INCDIRS) -O3 -xHost -mcmodel=medium -shared-intel -DLINUX
     CFLAGS        := $(INCDIRS) -O3 -mcmodel=medium -shared-intel -DLINUX
#     CFLAGS        := $(INCDIRS) -O2 -mcmodel=medium -shared-intel -DLINUX
#     CFLAGS        := $(INCDIRS) -O2 -mcmodel=medium -shared-intel -DLINUX
#     CFLAGS        := $(INCDIRS) -O2 -m64 -mcmodel=medium -shared-intel -DLINUX
  else
     CFLAGS        := $(INCDIRS) -O3 -xSSE4.2 -mcmodel=medium -shared-intel -DLINUX
#     CFLAGS        := $(INCDIRS) -O3 -xSSE4.2 -m64 -mcmodel=medium -shared-intel -DLINUX
  endif
  FLIBS          :=
  ifeq ($(DEBUG),full)
#     CFLAGS        := $(INCDIRS) -g -O0 -march=k8 -m64 -mcmodel=medium -DLINUX
     CFLAGS        := $(INCDIRS) -g -O0 -mcmodel=medium -shared-intel -DLINUX
  endif
  ifeq ($(NETCDF),enable)
#     HDF5HOME=/afs/crc.nd.edu/x86_64_linux/hdf/hdf5-1.8.6-linux-x86_64-static/lib
     HDF5HOME=/afs/crc.nd.edu/x86_64_linux/hdf/rhel6/1.8.8/intel-12.0/lib
...
#  ifeq ($(ZAS),yes)
# O3 appears to be an offensive on AMD chips 
     # FFLAGS1     :=  $(INCDIRS) -g -traceback -O2 -mcmodel=medium -Mextend -Bdynamic 
     FFLAGS1     :=  $(INCDIRS) -g -traceback -O2 -mcmodel=medium -Mextend 
#  else
#     FFLAGS1     :=  $(INCDIRS) -w -O3 -xSSE4.2 -assume byterecl -132 -i-dynami#c -assume buffered_io
#  endif
  ifeq ($(DEBUG),full)
     FFLAGS1       :=  $(INCDIRS) -g -O0 -traceback -Bdynamic -Mextend -mcmodel=medium -DALL_TRACE -DFULL_STACK -DFLUSH_MESSAGES
  endif
  FFLAGS2       :=  $(FFLAGS1)
  FFLAGS3       :=  $(FFLAGS1)
  DA            :=  -DREAL8 -DLINUX -DCSCA
#  DP            :=  -DREAL8 -DLINUX -DCSCA -DCMPI -DPOWELL -DADCSWAN
  ...
  CCBE          := $(CC)
#  ifeq ($(ZAS),yes)
     CFLAGS        := $(INCDIRS) -O3 -traceback -mcmodel=medium -DLINUX
#  else
#     CFLAGS        := $(INCDIRS) -O3 -xSSE4.2 -m64 -mcmodel=medium -DLINUX
#  endif
  FLIBS          :=
  ifeq ($(DEBUG),full)
     CFLAGS        := $(INCDIRS) -g -O0 -mcmodel=medium -DLINUX
  endif
  ifeq ($(NETCDF),enable)
#     HDF5HOME=/afs/crc.nd.edu/x86_64_linux/hdf/hdf5-1.8.6-linux-x86_64-static/lib
     HDF5HOME=/afs/crc.nd.edu/x86_64_linux/hdf/rhel6/1.8.8/gcc-4.4.6/lib
     NETCDFHOME=/afs/crc.nd.edu/user/d/dwirasae/software/netcdf-custom-4.1.3

     FLIBS      := $(FLIBS) -L$(HDF5HOME) -lhdf5 -L$(NETCDFHOME)/lib -lnetcdf -lnetcdff
  endif 
  CLIBS         :=
  MSGLIBS       :=
  $(warning (INFO) Corresponding machine found in cmplrflags.mk.)
  ...
  # NETCDFHOME=/afs/crc.nd.edu/x86_64_linux/netcdf/rhel6/4.1.3/gcc-4.4.7
  # NETCDFHOME=/afs/crc.nd.edu/x86_64_linux/scilib/netcdf/4.1.2/pgi-11.3/inst
  # NETCDFHOME=/afs/crc.nd.edu/x86_64_linux/scilib/netcdf/4.1.2/intel-12.0/inst
  ##NETCDFHOME=/afs/crc.nd.edu/x86_64_linux/scilib/netcdf/4.1.3
  # ifeq ($(NETCDF),enable)
  #   # NETCDFHOME=/afs/crc.nd.edu/x86_64_linux/scilib/netcdf/4.1.3
  #   FLIBS      := $(FLIBS) -l/usr/lib64/libcurl.so	
  # endif
